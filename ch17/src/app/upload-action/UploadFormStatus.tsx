...
function SubmitButton() {
  ...
  const fileSize = data?.get('file')?.size;
 ...
 */
export default function UploadFormStatus({ uploadAction }: { uploadAction: (...args: any[]) => Promise<any> }) {
  ...
  return (
    ...
    >
      <div className="text-lg font-bold">useFormStatus() 사용한 서버 액션</div>
      {/* 파일 입력 필드 */}
